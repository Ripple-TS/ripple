...
- Scope-related changes in `packages/tsrx/src/scope.js` - track bindings with appropriate `kind`
- CSS changes: `analyze/css-analyze.js` for parsing, `analyze/prune.js` for dead code elimination
