...
inside a helper does not change how the rest of that helper behaves. If a
component intentionally returns a renderable non-TSRX value, such as `null` or a
string, use `@Component`.
