 ...
 * Note: HTML block markers (hash comments and end markers) are left in the DOM
 * as they are part of the managed block lifecycle and only removed when content updates.
