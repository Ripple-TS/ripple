...
var root_11 = _$_.template(`<!><div class="after">after</div>`, 1);
...
export function LayoutWithMultiRootChildAndSibling(__anchor, _, __block) {
	_$_.push_component();
	...
	Layout(
		node_8,
		{
			children(__anchor, _, __block) {
				...
				MultiRootChild(node_9, {}, _$_.active_block);
