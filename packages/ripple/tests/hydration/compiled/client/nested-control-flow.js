...
var root = _$_.template(`<ul class="for-if"></ul>`, 1, 1);
var root_5 = _$_.template(`<li> </li>`, 1, 1);
var root_6 = _$_.template(`<li> </li>`, 0);
var root_4 = _$_.template(`<!>`, 1, 1);
var root_3 = _$_.template(`<ul class="for-switch"></ul>`, 1, 1);
...
var root_7 = _$_.template(`<div class="if-switch"><!></div>`, 1, 1);
var root_13 = _$_.template(`<p class="case-a">Case A</p>`, 1, 1);
var root_14 = _$_.template(`<p class="case-default">Default</p>`, 0);
var root_12 = _$_.template(`<!>`, 1, 1);
var root_11 = _$_.template(`<div class="if-switch-hidden"><!><p class="after">after</p></div>`, 1, 1);
...
var root_15 = _$_.template(`<ul class="for-if-switch-single"></ul>`, 1, 1);
...
var root_20 = _$_.template(`<ul class="for-if-switch-multi"></ul>`, 1, 1);
...
var root_25 = _$_.template(`<ul class="for-if-switch-disabled"></ul>`, 1, 1);
...
var root_30 = _$_.template(`<div class="switch-try"><!></div>`, 1, 1);
...
var root_48 = _$_.template(`<ul class="for-if-switch-try-single"></ul>`, 1, 1);
...
var root_57 = _$_.template(`<ul class="for-if-switch-try-multi"></ul>`, 1, 1);
...
export function ForIf(__anchor, _, __block) {
	...
	var fragment = root();
	var ul_1 = _$_.first_child_frag(fragment);
...
export function ForSwitch(__anchor, _, __block) {
	...
	var ul_2 = _$_.first_child_frag(fragment_2);
			...
			(__anchor, pattern_1) => {
...

				{
					var switch_case_0 = (__anchor) => {
						...
						var li_2 = _$_.first_child_frag(fragment_4);
...
export function IfSwitchHidden(__anchor, _, __block) {
	...
	var div_2 = _$_.first_child_frag(fragment_8);
...
export function ForIfSwitchSingle(__anchor, _, __block) {
	...
	var ul_3 = _$_.first_child_frag(fragment_11);
			...
			(__anchor, pattern_2) => {
...

				{
					var consequent_3 = (__anchor) => {
						...
						var node_7 = _$_.first_child_frag(fragment_13);

						{
							var switch_case_0_3 = (__anchor) => {
								var fragment_14 = root_18();
								var li_4 = _$_.first_child_frag(fragment_14);
...
export function ForIfSwitchMulti(__anchor, _, __block) {
	...
	var ul_4 = _$_.first_child_frag(fragment_15);
			...
			(__anchor, pattern_3) => {
...

				{
					var consequent_4 = (__anchor) => {
						...
						var node_9 = _$_.first_child_frag(fragment_17);

						{
							var switch_case_0_4 = (__anchor) => {
								var fragment_18 = root_23();
								var li_6 = _$_.first_child_frag(fragment_18);
...
export function ForIfSwitchWithDisabled(__anchor, _, __block) {
	...
	var ul_5 = _$_.first_child_frag(fragment_19);
			...
			(__anchor, pattern_4) => {
...

				{
					var consequent_5 = (__anchor) => {
						...
						var node_11 = _$_.first_child_frag(fragment_21);

						{
							var switch_case_0_5 = (__anchor) => {
								var fragment_22 = root_28();
								var li_8 = _$_.first_child_frag(fragment_22);
...
export function SwitchTry(__anchor, _, __block) {
	...
	var div_3 = _$_.first_child_frag(fragment_23);
...
export function ForSwitchTry(__anchor, _, __block) {
	...
	var fragment_25 = root_35();
	var ul_6 = _$_.first_child_frag(fragment_25);

	{
		_$_.for_keyed(
			...
			() => items,
			(__anchor, pattern_5) => {
				var fragment_26 = root_36();
				var node_14 = _$_.first_child_frag(fragment_26);

				{
					var switch_case_0_7 = (__anchor) => {
						var fragment_27 = root_37();
						var node_15 = _$_.first_child_frag(fragment_27);
					...
					var switch_case_default_7 = (__anchor) => {
						var fragment_28 = root_40();
						var node_16 = _$_.first_child_frag(fragment_28);
...
export function ForIfTry(__anchor, _, __block) {
	...
	var ul_7 = _$_.first_child_frag(fragment_29);
...
export function ForIfSwitchTrySingle(__anchor, _, __block) {
	...
	var __r_10 = false;
	const items = [{ id: 1, kind: 'a', show: true }];
	var fragment_32 = root_48();
	var ul_8 = _$_.first_child_frag(fragment_32);

	{
		_$_.for_keyed(
			...
			() => items,
			(__anchor, pattern_7) => {
				var fragment_33 = root_49();
				var node_19 = _$_.first_child_frag(fragment_33);

				{
					var consequent_7 = (__anchor) => {
						var fragment_34 = root_50();
						var node_20 = _$_.first_child_frag(fragment_34);

						{
							var switch_case_0_8 = (__anchor) => {
								var fragment_35 = root_51();
								var node_21 = _$_.first_child_frag(fragment_35);
							...
							var switch_case_default_8 = (__anchor) => {
								var fragment_36 = root_54();
								var node_22 = _$_.first_child_frag(fragment_36);
...
export function ForIfSwitchTryMulti(__anchor, _, __block) {
	...
	var ul_9 = _$_.first_child_frag(fragment_37);

	{
		_$_.for_keyed(
			...
			(__anchor, pattern_8) => {
				...
				var node_23 = _$_.first_child_frag(fragment_38);

				{
					var consequent_8 = (__anchor) => {
						var fragment_39 = root_59();
						var node_24 = _$_.first_child_frag(fragment_39);

						{
							var switch_case_0_9 = (__anchor) => {
								var fragment_40 = root_60();
								var node_25 = _$_.first_child_frag(fragment_40);
							...
							var switch_case_default_9 = (__anchor) => {
								var fragment_41 = root_63();
								var node_26 = _$_.first_child_frag(fragment_41);
