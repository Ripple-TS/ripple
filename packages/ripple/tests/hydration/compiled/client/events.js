...
var root = _$_.template(`<div><button class="increment">Increment</button><span class="count"> </span></div>`, 1, 1);
var root_1 = _$_.template(`<div><button class="decrement">-</button><span class="count"> </span><button class="increment">+</button></div>`, 1, 1);
var root_2 = _$_.template(`<div><button class="target">Target</button><span class="clicks"> </span><span class="hovers"> </span></div>`, 1, 1);
var root_3 = _$_.template(`<div><button class="btn">Click</button><span class="count"> </span><span class="action"> </span></div>`, 1, 1);
var root_4 = _$_.template(`<div><button class="toggle"> </button></div>`, 1, 1);
var root_5 = _$_.template(`<button class="child-btn"> </button>`, 1, 1);
var root_6 = _$_.template(`<div><!><span class="count"> </span></div>`, 1, 1);
...
export function MultiStateUpdate(__anchor, _, __block) {
	...
	var div_4 = _$_.first_child_frag(fragment_3);
...
export function ToggleButton(__anchor, _, __block) {
	...
	var div_5 = _$_.first_child_frag(fragment_4);
...
export function ParentWithChildButton(__anchor, _, __block) {
	...
	var div_6 = _$_.first_child_frag(fragment_6);
