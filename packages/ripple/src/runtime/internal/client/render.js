 ...
 * @param {Element} element
 * @param {any} value
 * @param {Record<string, string | number | undefined> | undefined} prev
 * @returns {void}
 */
 ...
 * @param {Record<string, string | number | undefined>} new_styles
 * @param {Record<string, string | number | undefined>} prev
 */
