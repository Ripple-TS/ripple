...
describe('project codegen', () => {
	it('generates a client entry that resolves component routes from ripple.config.ts', () => {
		...
		expect(source).toContain("typeof route?.component === 'function'");
		expect(source).toContain('return route.component;');
